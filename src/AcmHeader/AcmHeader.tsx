...
import { CogsIcon, CodeIcon } from '@patternfly/react-icons'
            ...
            toggleIcon={
                <svg width="18px" height="20px" viewBox="0 0 18 20" version="1.1">
                    ...
                    <g id="Help" stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
                        <g id="01.00-Help" transform="translate(-1277.000000, -29.000000)" fill="#EDEDED" fillRule="nonzero">
                ...
                <Dropdown
                    ...
                    dropdownItems={[
                        <DropdownItem onClick={() => launchToOCP('?perspective=admin')} key={'administrator'}>
                            <Title headingLevel="h2" size="md">
                                <span className="oc-nav-header__icon" style={iconStyles}><CogsIcon></CogsIcon></span>
                                Administrator
                            </Title>
                        </DropdownItem>,
                        <DropdownItem onClick={() => launchToOCP('?perspective=dev')} key={'devbutton'}>
                            <Title headingLevel="h2" size="md">
                                <span className="oc-nav-header__icon" style={iconStyles}><CodeIcon></CodeIcon></span>
                                Developer
                            </Title>
                        </DropdownItem>,
                    ]}
